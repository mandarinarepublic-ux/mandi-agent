// lib/sheetsCatalog.js — Catálogo desde CSV local en el repo
// Usa process.cwd() — compatible con ESM en Vercel sin import.meta

import { readFileSync } from 'fs';
import { join } from 'path';

const CSV_PATH = join(process.cwd(), 'data', 'catalogo.csv');
...
function getCatalog() {
  ...
  try {
    ...
    console.log(`SheetsCatalog: ${products.length} productos cargados (${porTienda})`);
    return products;
  } catch (err) {
...
export async function searchProducts(message, tienda) {
